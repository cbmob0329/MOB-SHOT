...
window.MOBSHOT_DATA = {
  ...
  gates: [
    { label: 'POWER+1', type: 'power', value: 1, color: '#ff5b4b', image: 'mt/gatepower1.png' },
    { label: 'RANGE+1', type: 'range', value: 1, color: '#49c8ff', image: 'mt/gaterage1.png' },
    { label: 'RAPID+1', type: 'rapid', value: 1, color: '#ff9b2c', image: 'mt/gaterapid1.png' },
    { label: 'LIFE+5', type: 'life', value: 5, color: '#54e96a', image: 'mt/gatelife5.png' },
    { label: 'WIDE+1', type: 'wide', value: 1, color: '#a864ff', image: 'mt/gatewide.png', rare: true }
  ]
};
